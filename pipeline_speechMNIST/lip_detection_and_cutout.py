...
class FaceDetector:
    ...
    def __init__(self):
        ...
        face_detection_model ='/face_detection_yunet_2023mar.onnx' # 'make_dataset_number_lipreading/face_detection_yunet_2023mar.onnx'
        self.facial_points_model = dlib.shape_predictor('/shape_predictor_68_face_landmarks.dat')
